...
Pod::Spec.new do |s|
  s.name             = 'MenuFactory'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MenuFactory.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/brennobemoura/MenuFactory'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'brennobemoura' => 'brenno@umobi.com.br' }
  s.source           = { :git => 'https://github.com/brennobemoura/MenuFactory.git', :tag => s.version.to_s }
